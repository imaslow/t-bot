...
import static com.example.demo.util.BotConstants.UNKNOWN_MESSAGE;
...
public class UnknownCommandImpl implements Command {
    ...
    public void execute(Update update) {
        sendBotMessageService.prepareAndSendMessage(update.getMessage().getChatId(), UNKNOWN_MESSAGE);
    }
}

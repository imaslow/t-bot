...
public class TextConstants {
    ...
    public static final String INFO_MESSAGE =
            "Школы Вильяма Рейли работают в России с 2009 года. " +
                    "Компания была создана в 2001 году и объединила капитал " +
                    "британских портфельных инвесторов и бизнесменов Восточной " +
                    "Европы. Один из инвесторов проекта Вильям Рейли – " +
                    "профессиональный преподаватель английского языка " +
                    "как иностранного. Вильям многие годы посвятил себя " +
                    "профессии учителя, а затем, став инвестором, загорелся " +
                    "идеей создания мировой сети школ иностранного языка. " +
                    "Первые годы своего существования Школы Вильяма Рейли " +
                    "не работали в России. Основными направлениями школ были " +
                    "летние лагеря для детей и английский язык для эмигрантов " +
                    "в Великобритании. С 2009 года школы Вильяма " +
                    "Рейли открываются в различных городах Российской Федерации " +
                    "и число филиалов растет с каждым годом.";
    public static final String CONTACTS_MESSAGE =
            "+7 4932 58-45-15\n\n" +
                    "+7 931 107-64-26\n\n" +
                    "ivanovo@wr-school.ru";
    ...
    public static final String PRESENT_SIMPLE =
            "Present Simple - это простое настоящее время. " +
                    "В Present Simple говорят о привычках, фактах, " +
                    "инструкциях, точных планах на будущее " +
                    "и даже о сюжетах книг. \n\n" +
                    "+\n\n" +
                    "I, you, we, they + V1 verb -> I work\n\n" +
                    "He, she, it + V1 verb + (s) -> He works\n\n" +
                    "-\n\n" +
                    "I, you, we, they + don't + V1 verb -> I don't work\n\n" +
                    "He, she, it + doesn't + V1 verb -> He doesn't work\n\n" +
                    "?\n\n" +
                    "Do + I, you, we, they + V1 verb -> Do I work?\n\n" +
                    "Does + He, she, it + V1 verb -> Does he work?";

    public static final String PAST_SIMPLE =
            "Past Simple — это простое прошедшее время. " +
                    "Его используют, чтобы рассказать факты из прошлого, " +
                    "поделиться воспоминаниями. \n\n" +
                    "+\n\n" +
                    "I, you, we, they, he, she, it + V2 irregular verb \n\n" +
                    "or + (ed) regular verb -> I went or I walked \n\n" +
                    "study + (ied) -> studied \n\n" +
                    "-\n\n" +
                    "I, you, we, they, he, she, it + didn't + \n\n" +
                    "V1 verb -> I didn't walk\n\n" +
                    "?\n\n" +
                    "Did + I, you, we, they, he, she, it + V1 verb\n\n" +
                    "-> Did I walk?";

    public static final String FUTURE_SIMPLE =
            "Future Simple - это простое будущее время. " +
                    "Мы даем обещания, мечтаем о будущем, " +
                    "рассказываем о своих планах и грядущих " +
                    "событиях по-английски именно в Future Simple \n\n" +
                    "+\n\n" +
                    "I, you, we, they, he, she, it + will + V1 verb \n\n" +
                    "-> I will go \n\n" +
                    "-\n\n" +
                    "I, you, we, they, he, she, it + will not \n\n" +
                    " + V1 verb -> I will not go \n\n" +
                    "?\n\n" +
    ...
    public static final String TO_BE_PRESENT =
            "+\n\n" +
                    "I + am -> I am a teacher\n\n" +
                    "He, she, it + is -> He is a teacher\n\n" +
                    "You, we, they + are -> We are a teachers\n\n" +
                    "-\n\n" +
                    "I + am + not -> I am not a teacher\n\n" +
                    "He, she, it + is + not-> He is not a teacher\n\n" +
                    "You, we, they + are + not -> We are not a teachers\n\n" +
                    "?\n\n" +
                    "Am + I -> Am I a teacher?\n\n" +
                    "Is + he, she, it -> Is he a teacher?\n\n" +
                    "Are + you, we, they -> Are you a teachers?";

    public static final String TO_BE_PAST =
            "+\n\n" +
                    "I, he, she, it + was -> I was a teacher\n\n" +
                    "You, we, they + were -> We were a teachers\n\n" +
                    "-\n\n" +
                    "I, he, she, it + was + not -> I was not a teacher\n\n" +
                    "You, we, they + were + not -> We were not a teachers\n\n" +
                    "?\n\n" +
                    "Was + I, he, she, it -> Was I a teacher?\n\n" +
                    "Were + you, we, they -> Were we a teachers?";

    public static final String TO_BE_FUTURE =
            "+\n\n" +
                    "I, he, she, it, you, we, they + will be\n\n" +
                    "-> I will be a superstar\n\n" +
                    "-\n\n" +
                    "I, he, she, it, you, we, they + will not be\n\n" +
                    "-> I will not be a looser\n\n" +
                    "?\n\n" +
